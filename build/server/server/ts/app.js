...
var design_1 = require("./controller/design");
...
dataSource_1.ds.initialize().then(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        app.get("/", function (request, response, next) {
            log.log("".concat(request.path, " -> appInfo"));
        ...
        app.get("/merchants", function (request, response, next) {
            log.log("".concat(request.path, " -> listAllMerchants"));
            (0, merchant_1.listAllMerchants)(request, response)
                .then(function () { return next; })["catch"](function (err) { return next(err); });
        });
        app.get("/design/:id", function (request, response, next) {
            log.log("".concat(request.path, " -> getDesign"));
            (0, design_1.getDesign)(request, response)
                .then(function () { return next; })["catch"](function (err) { return next(err); });
        });
        // run app
        app.listen(3000);
